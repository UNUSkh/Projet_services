...
// Define the interface for the data that will be passed to the component
...
@Component({
  selector: 'app-decouv-cards',
  templateUrl: './decouv-cards.component.html',
  styleUrls: ['./decouv-cards.component.css']
})
export class DecouvCardsComponent {
